...
class WeatherRepository {
    ...
    private val apiKey = "136e9be3e4d8cd6a52fa2c7109282ab1" // ✅ Your OpenWeatherMap API key

    suspend fun getWeather(city: String) = api.getCurrentWeather(city, apiKey, units = "metric")
